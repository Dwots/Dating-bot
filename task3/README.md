...
Простой учебный проект для сравнения трех стратегий кеширования:
...
Также можно вручную открыть:

```bash
curl http://127.0.0.1:5000/metrics
```

## 7. Что заливать на GitHub

Залей всю папку проекта:

```bash
git init
git add .
git commit -m "cache strategies practice"
```

## 8. Как сделать скрины

Для отчета достаточно сделать скрин консоли после команды:
